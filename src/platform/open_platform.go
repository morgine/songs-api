...
//}
//
//func CountTotalSummary(apps []*AppSummary) *Summary {
//	var totalSummaries []*wpt.UserSummary
//	// 累加
//	for _, appSummary := range apps {
//		for _, dateSummary := range appSummary.Summaries {
//			func() {
//				for _, totalSummary := range totalSummaries {
//					if totalSummary.RefDate == dateSummary.RefDate && totalSummary.UserSource == dateSummary.UserSource {
//						totalSummary.CancelUser += dateSummary.CancelUser
//						totalSummary.NewUser += dateSummary.NewUser
//						return
//					}
//				}
//				totalSummaries = append(totalSummaries, &wpt.UserSummary{
//					RefDate:    dateSummary.RefDate,
//					UserSource: dateSummary.UserSource,
//					NewUser:    dateSummary.NewUser,
//					CancelUser: dateSummary.CancelUser,
//				})
//			}()
//		}
//	}
